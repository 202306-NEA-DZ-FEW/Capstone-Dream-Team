            ...
            <div className='flex md:flex-row flex-col max-h-screen '>
                ...
                >
                    ...
                    <div className='flex w-full justify-center gap-4 mb-2 mt-2 '>
                        <Link
                            href='/signIn'
                            class='bg-white mt-8 py-3 px-8 text-lg rounded-full font-bold uppercase text-orange-400 border border-orange-400 tracking-widest'
                        >
                            {t("home.joinus.joinus")}
                        </Link>
                        <Link
                            href='/signUp'
                            class='bg-orange-400 hover:bg-orange-500 mt-8 py-3 px-8 text-lg rounded-full font-bold uppercase text-white tracking-widest'
                        >
